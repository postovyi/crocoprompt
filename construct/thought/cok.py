...
class ChainOfKnowledge(ZeroShotPrompt):
    def __init__(self, instructions: PromptSection, knowledge_triplets: list[Triplet], explanation: PromptSection) -> None:
        super().__init__(instructions)
        self.add_section(name="knowledge_triplets", section=PromptSection(content="\n\n".join([str(triplet) for triplet in knowledge_triplets])))
